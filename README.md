...
- `Pause / Resume` and `Stop` are the strongest controls today. In live validation they work against an active Descript Screen Recorder session when macOS Accessibility is granted.
